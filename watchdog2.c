    ...
    while (1)
    {
        ...
        switch (s)
        {
            case START:
                ...
                {
                    errorMessage(-1);
                    PRINT_MSG(logFile, times, PROGRAMNAME, "There's an error...program is continuing. \n\n");
                    s = START;
                    break;
                }
                break;
        ...
        if ((time(NULL) - startTime) >= 12)
        {
            ...
            PRINT_MSG(logFile, times, PROGRAMNAME, "The Watchdog was kicked after 12 seconds....results are logged. \n\n");
        }
